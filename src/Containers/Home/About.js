				...
				<div className="container">
					<div className="top-about-container">
						<div className="left-about">
							...
							<p>We search for the best quality beans around the world. We then take care of the roasting process on site. This guarentees that your coffee is always fresh and of the highest quality.</p>
						</div>
					...
					<div className="bottom-about-container">
						...
						<div className="pics">
							<div className="left-pic">
								...
								<h5>Traditional</h5>
								<p>Sometimes the best results come from the simplest actions.</p>
							</div>
							<div className="left-pic">
								...
								<h5>Drip</h5>
								<p>Perfect for someone who wants more caffeine  and a vibrant taste.</p>
							</div>
							<div className="left-pic">
								...
								<h5>Cold Brew</h5>
								<p>Great for a hot day and for those who want something sweeter.</p>
							</div>
						</div>
					</div>
				</div>
